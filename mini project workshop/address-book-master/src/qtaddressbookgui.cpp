...
void QtAddressBookGUI::createWidgets()
{
    ...
    newContactButton->setStyleSheet("background-color: blue;color:black");
     editContactButton->setStyleSheet("background-color:yellow ;color:black");
     searchContactButton->setStyleSheet("background-color:yellow ;color:black");
